...
public class HelloServiceTest {
	...
	public void testGetUserName() {
		...
		MatcherAssert.assertThat(answer, equalTo("Sahil Sharma - Prod branch"));
	}

	@Test
	public void testGetWelcomeText() {
		String answer = this.helloService.getWelcomeText();
		MatcherAssert.assertThat(answer, equalTo("Welcome to the sample application created for devops assignment, This is prod branch"));
	}
